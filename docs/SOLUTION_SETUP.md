...
This guide covers the complete setup for the NLtoDAX application.
...
5. Verify the configuration:
   - Under **Single-page application**, you should see `http://localhost:8000` listed as a redirect URI
   - Under **Implicit grant and hybrid flows**, leave **Access tokens** and **ID tokens** unchecked (MSAL.js 2.x uses PKCE, not implicit flow)

> **Note:** For production deployment, add your production URL (for example, `https://your-app.azurewebsites.net`) as an additional redirect URI.
...
6. Grant Access to AI Foundry Resource:
   ...
   - Navigate to your **Azure AI Foundry** resource (where the LLM model is provisioned)
...
> **Note:** For initial testing, the `gpt-5-mini` model with Global Standard deployment is acceptable.
...
6. Open the deployed model details page and copy the following to your `.env` file:
